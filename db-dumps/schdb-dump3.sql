...
INSERT INTO `authorized_users` VALUES (1,'efc1413049560077'),(2,'0399edcca4c68010'),(3,'de51960272e8a380');
...
INSERT INTO `event_group_connections` VALUES (0,9,'2023-01-25 07:23:38'),(2,0,'2023-01-25 02:29:10'),(6,0,'2023-01-25 02:43:36'),(7,2,'2023-01-25 02:45:01');
...
INSERT INTO `events` VALUES (0,6,'2023-01-25 01:21:20','2023-01-26 01:21:20','MyEvent','event Text','2023-01-25 07:23:38','2023-01-25 07:23:38'),(2,0,'2023-01-25 01:41:20','2023-01-25 01:58:20','MyeventUpdated','gsdfhsdfh Frfrffrfr','2023-01-25 02:29:10','2023-01-25 04:14:42'),(6,0,'2023-01-25 01:21:20','2023-01-25 01:21:20','dsg','sdgdsfhg','2023-01-25 02:43:36','2023-01-25 04:14:46'),(7,2,'2021-03-02 12:22:00','2021-03-05 04:35:00','dfgsdfh UPdated!!!! sagsdfg','adfhdfh fdsdaf gsdfh','2023-01-25 02:45:01','2023-01-25 05:55:00');
...
INSERT INTO `groups` VALUES (0,'/IG0','',0,1,'2023-01-19 17:35:51','2023-01-19 17:35:51'),(1,'/IG1','',0,1,'2023-01-19 17:35:51','2023-01-19 17:35:51'),(2,'/IG2','',3,1,'2023-01-19 04:51:09','2023-01-19 04:51:09'),(3,'/Administration','Administarators of ScheduleR',1,20,'2023-01-19 22:49:50','2023-01-19 22:49:50'),(4,'/IG4','',3,1,'2023-01-20 10:20:48','2023-01-20 10:20:48'),(6,'asf','sdfas',0,2,'2023-01-21 07:25:51','2023-01-21 07:25:51'),(7,'/Observers','Group containing list of observers',4,512,'2023-01-22 04:01:30','2023-01-22 04:01:30'),(9,'/IG9','',3,1,'2023-01-25 07:21:26','2023-01-25 07:21:26');
/*!40000 ALTER TABLE `groups` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `query_status_list`
--

DROP TABLE IF EXISTS `query_status_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `query_status_list` (
...
INSERT INTO `user_group_connections` VALUES (0,0,'2023-01-19 17:23:58'),(1,1,'2023-01-19 17:40:05'),(2,2,'2023-01-19 04:51:09'),(2,3,'2023-01-21 06:56:33'),(3,4,'2023-01-20 10:20:48'),(6,9,'2023-01-25 07:21:26');
...
INSERT INTO `users` VALUES (0,'alexsmir','alexroot','Смирнов','Александр','Михайлович','','2023-01-16 02:54:00','2023-01-19 22:40:08'),(1,'suser','noauth','System','User','','','2023-01-17 22:29:20','2023-01-17 22:29:20'),(2,'pussynatuse','newpassword','O','Khva Sen','','','2023-01-19 04:51:09','2023-01-19 19:21:34'),(3,'/NU3','65379a7b','Sm','Al','','','2023-01-20 10:20:48','2023-01-20 10:20:48'),(6,'/NU6','2fc2b63b','New','User','','','2023-01-25 07:21:26','2023-01-25 07:21:26');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `is_event_public` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `is_event_public`(event_id INT UNSIGNED) RETURNS tinyint(1)
    DETERMINISTIC
BEGIN
DECLARE owner_id INT UNSIGNED;

SET owner_id = get_event_owner_id(event_id);

RETURN EXISTS (
	SELECT `groups`.*
		FROM `groups`
        INNER JOIN (event_group_connections, user_group_connections)
        ON (event_group_connections.`Group ID` = `groups`.`ID` AND user_group_connections.`Group ID` = `groups`.`ID`)
        WHERE 
			event_group_connections.`Event ID` = event_id AND
            user_group_connections.`User ID` <> owner_id
		LIMIT 1
);
END ;;
DELIMITER ;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `complex_user_register`(
    ...
    IN cust_id INT UNSIGNED, IN cust_key VARCHAR(16),
    OUT user_id INT UNSIGNED, OUT pwd VARCHAR(45), OUT query_status INT UNSIGNED
)
BEGIN
	DECLARE auth BOOLEAN;
    DECLARE ig_id INT UNSIGNED;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_available_events` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_available_events`(
	IN user_id INT UNSIGNED
)
BEGIN
    
    SELECT `events`.*, is_event_public(`events`.`ID`) as `Public Event`
		FROM `events`
        INNER JOIN (user_group_connections, event_group_connections)
        ON (user_group_connections.`Group ID` = event_group_connections.`Group ID` AND `events`.`ID` = event_group_connections.`Event ID`)
        WHERE user_group_connections.`User ID` = user_id;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_event_groups` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_event_groups`(IN event_id INT UNSIGNED)
BEGIN
	SELECT `groups`.*
		FROM `groups`
        INNER JOIN (event_group_connections)
        ON (event_group_connections.`Group ID` = `groups`.`ID`)
        WHERE (event_group_connections.`Event ID` = event_id);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_users_data` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_users_data`()
BEGIN
	SELECT `ID`, `Login`, `Last Name`, `First Name`, 
		`Middle Name`, `BIO`, get_user_access_level(`ID`) as 'Access Level', `Registration DateTime`, `Last Update DateTime`
	FROM users;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `log_in`(
	IN login VARCHAR(45), IN pwd VARCHAR(45),
    OUT user_id INT UNSIGNED, OUT user_key VARCHAR(16),
    OUT query_status TINYINT UNSIGNED
)
BEGIN
    SELECT users.`ID`
	...
	IF EXISTS (SELECT users.`ID` FROM users WHERE users.`Login` = login AND `Password` = pwd) THEN
		SELECT `Access Key`
        ...
        IF user_key IS NULL THEN
			SET user_key = get_random_string(16);
			INSERT INTO authorized_users (`User ID`, `Access Key`) VALUES (user_id, user_key);
		END IF;
        SET query_status = 0;
	ELSE
		SET query_status = 16;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `log_out`(
	IN user_id INT UNSIGNED, OUT query_status TINYINT UNSIGNED
)
BEGIN
    
	DELETE FROM authorized_users WHERE authorized_users.`User ID` = user_id;
	SET query_status = 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2023-01-25  8:01:00
